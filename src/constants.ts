...
export const ANIMALS: Animal[] = [
  { 
    id: 1, name: 'Avestruz', numbers: [1, 2, 3, 4], emoji: '🦤',
  ...
  { 
    id: 2, name: 'Águia', numbers: [5, 6, 7, 8], emoji: '🦅',
  ...
  { 
    id: 3, name: 'Burro', numbers: [9, 10, 11, 12], emoji: '🫏',
  ...
  { 
    id: 4, name: 'Borboleta', numbers: [13, 14, 15, 16], emoji: '🦋',
  ...
  { 
    id: 5, name: 'Cachorro', numbers: [17, 18, 19, 20], emoji: '🐕',
  ...
  { 
    id: 6, name: 'Cabra', numbers: [21, 22, 23, 24], emoji: '🐐',
  ...
  { 
    id: 7, name: 'Carneiro', numbers: [25, 26, 27, 28], emoji: '🐏',
  ...
  { 
    id: 8, name: 'Camelo', numbers: [29, 30, 31, 32], emoji: '🐪',
  ...
  { 
    id: 9, name: 'Cobra', numbers: [33, 34, 35, 36], emoji: '🐍',
  ...
  { 
    id: 10, name: 'Coelho', numbers: [37, 38, 39, 40], emoji: '🐇',
  ...
  { 
    id: 11, name: 'Cavalo', numbers: [41, 42, 43, 44], emoji: '🐎',
  ...
  { 
    id: 12, name: 'Elefante', numbers: [45, 46, 47, 48], emoji: '🐘',
  ...
  { 
    id: 13, name: 'Galo', numbers: [49, 50, 51, 52], emoji: '🐓',
  ...
  { 
    id: 14, name: 'Gato', numbers: [53, 54, 55, 56], emoji: '🐈',
  ...
  { 
    id: 15, name: 'Jacaré', numbers: [57, 58, 59, 60], emoji: '🐊',
  ...
  { 
    id: 16, name: 'Leão', numbers: [61, 62, 63, 64], emoji: '🦁',
  ...
  { 
    id: 17, name: 'Macaco', numbers: [65, 66, 67, 68], emoji: '🐒',
  ...
  { 
    id: 18, name: 'Porco', numbers: [69, 70, 71, 72], emoji: '🐖',
  ...
  { 
    id: 19, name: 'Pavão', numbers: [73, 74, 75, 76], emoji: '🦚',
  ...
  { 
    id: 20, name: 'Peru', numbers: [77, 78, 79, 80], emoji: '🦃',
  ...
  { 
    id: 21, name: 'Touro', numbers: [81, 82, 83, 84], emoji: '🐂',
  ...
  { 
    id: 22, name: 'Tigre', numbers: [85, 86, 87, 88], emoji: '🐅',
  ...
  { 
    id: 23, name: 'Urso', numbers: [89, 90, 91, 92], emoji: '🐻',
  ...
  { 
    id: 24, name: 'Veado', numbers: [93, 94, 95, 96], emoji: '🦌',
  ...
  { 
    id: 25, name: 'Vaca', numbers: [97, 98, 99, 0], emoji: '🐄',
