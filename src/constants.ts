...
export const ANIMALS: Animal[] = [
  { 
    id: 1, name: 'Avestruz', slug: 'avestruz', numbers: [1, 2, 3, 4], 
    image: 'https://img.icons8.com/fluency/144/ostrich.png',
  ...
  { 
    id: 2, name: 'Águia', slug: 'aguia', numbers: [5, 6, 7, 8], 
    image: 'https://img.icons8.com/fluency/144/eagle.png',
  ...
  { 
    id: 3, name: 'Burro', slug: 'burro', numbers: [9, 10, 11, 12], 
    image: 'https://img.icons8.com/fluency/144/donkey.png',
  ...
  { 
    id: 4, name: 'Borboleta', slug: 'borboleta', numbers: [13, 14, 15, 16], 
    image: 'https://img.icons8.com/color/144/butterfly.png',
  ...
  { 
    id: 5, name: 'Cachorro', slug: 'cachorro', numbers: [17, 18, 19, 20], 
    image: 'https://img.icons8.com/color/144/dog.png',
  ...
  { 
    id: 6, name: 'Cabra', slug: 'cabra', numbers: [21, 22, 23, 24], 
    image: 'https://img.icons8.com/color/144/goat.png',
  ...
  { 
    id: 7, name: 'Carneiro', slug: 'carneiro', numbers: [25, 26, 27, 28], 
    image: 'https://img.icons8.com/color/144/sheep.png',
  ...
  { 
    id: 8, name: 'Camelo', slug: 'camelo', numbers: [29, 30, 31, 32], 
    image: 'https://img.icons8.com/fluency/144/camel.png',
  ...
  { 
    id: 9, name: 'Cobra', slug: 'cobra', numbers: [33, 34, 35, 36], 
    image: 'https://img.icons8.com/color/144/snake.png',
  ...
  { 
    id: 10, name: 'Coelho', slug: 'coelho', numbers: [37, 38, 39, 40], 
    image: 'https://img.icons8.com/color/144/rabbit.png',
  ...
  { 
    id: 11, name: 'Cavalo', slug: 'cavalo', numbers: [41, 42, 43, 44], 
    image: 'https://img.icons8.com/color/144/horse.png',
  ...
  { 
    id: 12, name: 'Elefante', slug: 'elefante', numbers: [45, 46, 47, 48], 
    image: 'https://img.icons8.com/color/144/elephant.png',
  ...
  { 
    id: 13, name: 'Galo', slug: 'galo', numbers: [49, 50, 51, 52], 
    image: 'https://img.icons8.com/fluency/144/rooster.png',
  ...
  { 
    id: 14, name: 'Gato', slug: 'gato', numbers: [53, 54, 55, 56], 
    image: 'https://img.icons8.com/color/144/cat.png',
  ...
  { 
    id: 15, name: 'Jacaré', slug: 'jacare', numbers: [57, 58, 59, 60], 
    image: 'https://img.icons8.com/fluency/144/alligator.png',
  ...
  { 
    id: 16, name: 'Leão', slug: 'leao', numbers: [61, 62, 63, 64], 
    image: 'https://img.icons8.com/color/144/lion.png',
  ...
  { 
    id: 17, name: 'Macaco', slug: 'macaco', numbers: [65, 66, 67, 68], 
    image: 'https://img.icons8.com/fluency/144/monkey.png',
  ...
  { 
    id: 18, name: 'Porco', slug: 'porco', numbers: [69, 70, 71, 72], 
    image: 'https://img.icons8.com/color/144/pig.png',
  ...
  { 
    id: 19, name: 'Pavão', slug: 'pavao', numbers: [73, 74, 75, 76], 
    image: 'https://img.icons8.com/color/144/peacock.png',
  ...
  { 
    id: 20, name: 'Peru', slug: 'peru', numbers: [77, 78, 79, 80], 
    image: 'https://img.icons8.com/color/144/turkey.png',
  ...
  { 
    id: 21, name: 'Touro', slug: 'touro', numbers: [81, 82, 83, 84], 
    image: 'https://img.icons8.com/color/144/bull.png',
  ...
  { 
    id: 22, name: 'Tigre', slug: 'tigre', numbers: [85, 86, 87, 88], 
    image: 'https://img.icons8.com/fluency/144/tiger.png',
  ...
  { 
    id: 23, name: 'Urso', slug: 'urso', numbers: [89, 90, 91, 92], 
    image: 'https://img.icons8.com/color/144/bear.png',
  ...
  { 
    id: 24, name: 'Veado', slug: 'veado', numbers: [93, 94, 95, 96], 
    image: 'https://img.icons8.com/color/144/deer.png',
  ...
  { 
    id: 25, name: 'Vaca', slug: 'vaca', numbers: [97, 98, 99, 0], 
    image: 'https://img.icons8.com/color/144/cow.png',
